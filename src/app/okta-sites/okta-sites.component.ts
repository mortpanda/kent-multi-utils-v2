...
@Component({
  selector: 'app-okta-sites',
  templateUrl: './okta-sites.component.html',
  styleUrls: ['./okta-sites.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class OktaSitesComponent implements OnInit {
  smallScreen: boolean;
  ...
  async ngOnInit() {
    ...
    switch (this.strUserSession == true) {
      ...
      case true: {
        ...
        this.myWebCache = await localStorage.getItem('oktaSites');

        if (this.myWebCache == null) {
          console.log('Okta sites empty');
