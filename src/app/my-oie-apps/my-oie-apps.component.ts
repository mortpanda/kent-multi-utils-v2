...
@Component({
  selector: 'app-my-oie-apps',
  templateUrl: './my-oie-apps.component.html',
  styleUrls: ['./my-oie-apps.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class MyOieAppsComponent implements OnInit {
  smallScreen: boolean;
  ...
  async ngOnInit() {
    ...
    switch (this.strUserSession == true) {
      ...
      case true: {
        ...
        this.myWebCache = await localStorage.getItem('oieApps');

        if (this.myWebCache == null) {
          console.log('OIE Apps empty');
